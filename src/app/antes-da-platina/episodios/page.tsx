...
export const metadata: Metadata = {
  title: "Episódios Antes da Platina | NewGame+",
  description:
    "Todos os episódios da série Antes da Platina — publicados e agendados — num só lugar.",
};

export default async function AntesDaPlatinaEpisodiosPage() {
    ...
    <>
      ...
      <main>
        <PageHeader
          ...
          description="Todos os episódios da série, publicados e agendados, num só lugar."
        />
